...
class Model_Q:
    def __init__(self): 
        ...
        self.dy_4_pos = 0
        self.dy_4_limits = [50, 1023] 
        self.dy_1_pos = 0
        self.dy_1_limits = [0, 540]
        self.dy_2_pos = 0 #rotation motor

        self.dy_2_limits = [1000, 100]      
        self.dy_3_pos = 0
        self.dy_3_limits = [100, 900] 
        self.dy_5_pos = 0
        self.dy_5_limits = [100, 1000] 
            ...
            for x in test_data:
                ...
                for event in data:
                    ...
                    if (control[0] & 0xF0) == 176:
                        ...
                        print("Control ID: ", control_id, "; Control Val: ", control_val)
                        if (self.mode):
